            ...
            <md-steppers class="md-small-hide" md-alternative>
                <md-step id="first" md-label="Information Extraction">
                    <div class="md-image-wrapper">
                        <div class="md-image-wrapper">
                            <img class="md-image" src="./assets/img/modules/modules-ex-step-1.png" alt="Information Extraction">
                        </div>
                    </div>
                ...
                <md-step id="second" md-label="Intent Assembly">
                    <div class="md-image-wrapper">
                        <img class="md-image" src="./assets/img/modules/modules-ex-step-2.png" alt="Intent Assembly">
                    </div>
                    <p class="md-body-2 note-block">
                ...
                <md-step id="third" md-label="Intent Confirmation">
                    <div class="md-image-wrapper">
                        <img class="md-image" src="./assets/img/modules/modules-ex-step-3.png" alt="Intent Confirmation">
                    </div>
                    <p class="md-body-2 note-block">
                ...
                <md-step id="fourth" md-label="Conflict Detection">
                    <div class="md-image-wrapper">
                        <img class="md-image" src="./assets/img/modules/modules-ex-step-4.png" alt="Conflict Detection">
                    </div>
                    <p class="md-body-2 note-block">
                        Our goal for Lumi is to prevent conflicting device configurations that result from its use of Nile as higher-level abstraction language. Therefore, designing the Conflict Detection module for Lumi requires identifying the type of conflicts that can arise from the operations supported by Nile. To this end, we opted for a design of Lumi's Conflict Detection module uses a pre-trained learning model, in the form of the well-known Random Forest Classifier, to label pairs of intents as conflicts or being conflict-free.
                    </p>
                </md-step>

                <md-step id="fifth" md-label="Intent Deployment">
                    <div class="md-image-wrapper">
                        <img class="md-image" src="./assets/img/modules/modules-ex-step-5.png" alt="Intent Deployment">
                    </div>
                    <p class="md-body-2 note-block">
